...
async function runTest() {
    ...
    try {
        ...
        console.assert(response4 == "P4 Shields: 0", "P4 Shields Assertion Failed");
        ...
        console.assert(num2 == "P2 # Cards: 11", "P2 Shields Assertion Failed");
        ...
        console.assert(num4 == "P4 # Cards: 12", "P4 Shields Assertion Failed");
